...
public class Cellphone implements Phone{
    ...
    Iterator<Contact> iterator = kontak.iterator();
    ...
    public void telpon() throws PulsaTidakCukupException {
    int biaya = 4000;
    if (this.balance < biaya) {
        throw new PulsaTidakCukupException(biaya - this.balance);
    }
    this.balance -= biaya;
    System.out.println("Melakukan panggilan... Pulsa dikurangi " + biaya + ". Sisa pulsa: " + this.balance);
}

public void chat() throws PulsaTidakCukupException {
    int biaya = 2000;
    if (this.balance < biaya) {
        throw new PulsaTidakCukupException(biaya - this.balance);
    }
    this.balance -= biaya;
    System.out.println("Mengirim pesan chat... Pulsa dikurangi " + biaya + ". Sisa pulsa: " + this.balance);
}
